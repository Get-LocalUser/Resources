...
- [What’s new in MS Intune](https://learn.microsoft.com/en-us/mem/intune/fundamentals/whats-new)
- [Refined MS Learn](https://github.com/merill/refined-microsoft-learn)
...
- [tbone.se](https://tbone.se/)
- [LazyAdmin](https://lazyadmin.nl/)
- [TheITBros](https://theitbros.com/)
- [GetRubix](https://www.getrubix.com/)
- [t3chn1ck](https://t3chn1ck.wordpress.com/)
- [InTheCloud247](https://www.inthecloud247.com/)
- [CloudInfra](https://cloudinfra.net/)
- [woshub](https://woshub.com/)
- [ourcloudnetwork](https://ourcloudnetwork.com/)
- [Merill](https://merill.net/)
- [Just about the Modern Workplace](https://joostgelijsteen.com/)
- [doitpshway](https://doitpshway.com/)
- [Intune Tech](https://intune.tech/)

## Miscellaneous/Useful

- [Group Policy Search](https://gpsearch.azurewebsites.net/)
- [Browser Sandboxing](https://www.browserling.com/browser-sandbox)
- [Uninstall View](https://www.nirsoft.net/utils/uninstall_view.html)
- [OhMyPosh](https://ohmyposh.dev/docs/themes)
- [CMTrace](https://call4cloud.nl/wp-content/uploads/2022/07/cmtrace.zip)
- [Visual 8-bit Binary to Decimal Converter](https://openprocessing.org/sketch/160659/)
- [Massgrave - MS Activation Scripts](https://massgrave.dev/index.html)
- [Massgrave - Genuine Install Media](https://massgrave.dev/genuine-installation-media.html)
- [Report on Installed Browser Extensions](https://intune.tech/2023/12/06/Reporting-on-installed-browser-extensions.html)

## M365 & Azure

- [M365 Dev Tenant](https://developer.microsoft.com/en-us/microsoft-365/dev-program)
- [M365Maps](https://m365maps.com/)
- [Conditional Access Documenter & Microsoft Entra Mind Map](https://idpowertoys.merill.net/)
- [cmd.ms](https://cmd.ms/)
...
- [Naming Tool](https://nametune.vercel.app/)
...
- [Interactive Trainings](https://regale.cloud/Microsoft/viewer/2980/intune-home/index.html#/0/0)
- [My Top 5 Intune Community Tools](https://scloud.work/top-5-intune-community-tools/)
- [Intune Community Tools](https://www.reddit.com/r/Intune/comments/1749xvk/intune_community_tools/?share_id=ZrnFGCaK5PE0USwpGcRsm)
- [Intune Debug Toolkit](https://msendpointmgr.com/intune-debug-toolkit/) (Has a PS module)
- [Drive Mapping Generator](https://intunedrivemapping.azurewebsites.net/)
- [Setup Packager for Intune](https://blog.tugi.ch/scripts-and-tools/setup-packager-for-intune)
- [Remediation Scripts](https://github.com/JayRHa/EndpointAnalyticsRemediationScripts)
- [ADMX Templates](https://admx.help/)
- [Registry to PowerShell Converter](https://reg2ps.azurewebsites.net/)
- [Registry to PowerShell](https://chrispro.tech/tools/registry-to-remediation)
- [Run in Sandbox](https://github.com/damienvanrobaeys/Run-in-Sandbox)
- [PSADT](https://psappdeploytoolkit.com/)
- [PSADT GUI](https://blog.tugi.ch/deployment-editor-preview#TheEditor)
- [OSDCloud](https://www.osdcloud.com/)
- [euctoolbox](https://euctoolbox.com/)
